...
const NoItemInfo = () => (
  <section className="my-4 flex flex-1 flex-col items-center justify-center gap-y-4 rounded-xl bg-lightmode-green px-4 py-20 text-center text-white dark:bg-darkmode-green">
