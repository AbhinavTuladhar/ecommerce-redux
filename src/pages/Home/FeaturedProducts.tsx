...
const FeatureCardFirst = () => (
  <article className="flex h-full flex-col items-center justify-center gap-y-7 rounded-xl bg-[#c8a938] px-4 py-4 text-black lg:py-12">
    <div className="flex flex-col items-center gap-y-1">
      <h2 className="fluid-text-2xl font-semibold uppercase"> Newest clothes </h2>
      <h3 className="fluid-text-5xl font-semibold uppercase"> Big sale </h3>
    </div>
  ...
  <article className="flex h-full flex-col items-center justify-between rounded-xl bg-[#fb8787] px-4 py-4 text-white lg:flex-row lg:py-0">
    ...
    <div className="flex flex-col justify-center gap-y-7">
      <div className="flex flex-col gap-y-2">
        <h2 className="fluid-text-2xl uppercase"> Latest tech </h2>
        <h2 className="fluid-text-3xl uppercase"> Super sale </h2>
      </div>
      <button className="fluid-text-xl self-center rounded-md bg-black p-3 font-semibold uppercase duration-500 hover:cursor-pointer hover:bg-gray-800 active:scale-95">
        Shop now
      </button>
    </div>
  </article>
  ...
  <article className="flex h-full flex-col items-center justify-between rounded-xl bg-[#ff9564] px-4 py-4 lg:flex-row lg:py-0">
    <div className="flex flex-col items-center gap-1">
      <div className="grid h-24 w-48 font-semibold text-black">
        <span className="fluid-text-4xl col-start-1 row-start-1 flex h-full items-center justify-center font-bold">
          {' '}
          20%{' '}
        </span>
...
const FeaturedProducts: React.FC = () => {
  return (
    <div className="mx-auto flex w-container flex-col gap-8 py-8">
      <h2 className="fluid-text-3xl font-semibold uppercase"> Featured products </h2>
